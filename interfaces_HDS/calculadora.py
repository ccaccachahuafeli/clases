...
e_texto.config(bg="#2aecdd")
# e_texto=Entry(ventana,background="springgreen")
# e_texto=Entry(ventana,border=3)
...
boton_borrar = Button(ventana, text = "clear", width= 35, height = 2, command = lambda: borrar())
...
boton_igual = Button(ventana, text = "=", width= 13, height = 2, command = lambda: hacer_operacion())
...
boton_igual.grid(row= 4, column = 1,columnspan=2, padx = 5, pady = 5)
